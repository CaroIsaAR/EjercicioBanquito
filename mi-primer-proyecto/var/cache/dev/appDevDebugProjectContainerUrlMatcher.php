...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ($pathinfo === '/insert-mov') {
            return array (  '_controller' => 'Prueba\\PrimerBundle\\Controller\\DefaultController::insertarMovAction',  '_route' => 'insertar_movimientos',);
        }

        // select_movimientos
        if ($pathinfo === '/select-mov') {
            return array (  '_controller' => 'Prueba\\PrimerBundle\\Controller\\DefaultController::selectMovAction',  '_route' => 'select_movimientos',);
        }
